...
<body onload="loadData('travel')">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="saveChanges('travel')">Save Changes</button>
				</div>
			</div>
		</div>
	</div>
	...
	<nav class="navbar navbar-expand-md navbar-light bg-light shadow-sm">
		<div class="container-fluid"> <a class="navbar-brand  fw-bold text-primary" href="#">Travel Blog</a>
